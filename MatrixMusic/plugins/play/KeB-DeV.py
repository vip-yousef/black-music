...
bot_id = app.bot_token.split("7183756114:AAF9knQOGi3cqnKYwrpZKED90v3-hHbBqig")[0]
dev_owner = int(6855645033)
owner = (OWNER_ID)
...
start_text = "**welcome {} , its just a test bot - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**"
...
[("• قسم الاحصائيات •")],
[("الاحصائيات"),("نسخه")],
[("عرض المجموعات"),("نسخه للجروبات"),("عدد القروبات")],
...
async def app_start(c:Client,m:Message):
	...
	if str(user) in banD:
		...
		return await m.reply(f"**• عذرا {mm} انت محظور من استخدام البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**",reply_markup=dev_ch_bu)
		
	if int(user) == dev_owner:
		return await m.reply(f"- اليك قائمة المطور الخاصة في بوتك",reply_markup=OwnerM)
	
	if str(user) in mainSudoVII:
		return await m.reply(f"- اليك قائمة المطور الخاصة في بوتك",reply_markup=main_dev_key)
	...
	if (not is_user(id=str(user))):
		...
		try:
			...
			await app.send_message(owner,"**دخل عضو جديد للبوت ولم استطع تحديد معلوماته - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
@app.on_message(filters.command("اخفاء الكيبورد","")&filters.private)
...
async def __get_copy(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		await cc.delete()
		try:
			await m.reply_document(document=users,caption=f"**Bot users : {uc} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		except:
			await m.reply("**• لم يقم اي عضو بالدخول الي بوتك - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		try:
			await m.reply_document(document=groups,caption=f"**Bot groups : {gc} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		except:
			await m.reply("**• لم يتم تفعيل اي مجموعات في بوتك - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		try:
			await m.reply_document(document=band,caption=f"**Band users : {bc} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		except:
			await m.reply("**• لا يوجد اعضاء محظورين في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		try:
			await m.reply_document(document=sudos,caption=f"**Sudo users : {sc} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		except:
			await m.reply("**• لا يوجد مطورين في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		try:
			await m.reply_document(document=main,caption=f"**Main devs : {mc} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		except:
			await m.reply("**• لا يوجد مطورين اساسيين في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def show_groups(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		for gr in groups:
			text += f"{x} - {gr} \n"
			x+=1
		i =await m.reply("**• جاري عرض القروبات - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(.5)
		leng = len(open(f"groups{bot_id}.json","r").readlines())
		if leng == 0:
			return await i.edit("**• لا توجد مجموعات تم تفعيلها في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def __gcopy(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		gc = len(open(f"groups{bot_id}.json","r").readlines())
		i = await m.reply("**• جاري جلب نسخه للمجموعات - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(1.5)
		try:
			await i.delete()
			...
			await i.delete()
			await m.reply("**• لا توجد مجموعات تم تفعيلها في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def get_groups_count(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		leng = len(open(f"groups{bot_id}.json","r").readlines())
		if leng == 0:
			return await m.reply("**• لا توجد مجموعات تم تفعيلها في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def show_links(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		for link in sl:
			text += f"{x} - {link}"
			x += 1
		l = await m.reply("**• جاري عرض الروابط - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(.5)
		if lenl == 0:
			return await l.edit("**• لا توجد مجموعات تم تفعيلها في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def get_copy___band(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		l = await m.reply("**• جاري جلب نسخه للمحظورين - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(2)
		if lenb == 0:
			return await l.edit("**• لم يتم حظر اي عضو من استخدام البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		await l.delete()
		await m.reply_document(document=file,caption=f"**Band users {lenb} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .")
		return
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def countofuserBan(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		l = await m.reply("**• جاري حساب عدد الاعضاء - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		lens = len(open(f"band{bot_id}.json","r").readlines())
		time.sleep(.5)
		if lens == 0:
			return await l.edit("**• لم يدخل اي عضو للبوت حتي الآن - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return await l.edit(f"**• عدد اعضاء بوتك {lens} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def ShowMain(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		l = await m.reply("**• جاري عرض المطورين الاساسيين - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		x = 1
		text = "**Bot Main Users **:\n\n"
		for su in file:
			text += f"{x} - {su}"
		...
		time.sleep(1)
		if lens == 0:
			return await l.edit("**• لم يتم رفع مطورين اساسيين في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return await l.edit(text=text)
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def get_MainSudo(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		l = await m.reply("**• جاري جلب نسخه للمطورين الاساسيين- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(2)
		if lenb == 0:
			return await l.edit("**• لم تقم برفع اي مطور اساسي في البوت- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		await l.delete()
		await m.reply_document(document=file,caption=f"**Sudo Main Users {lenb} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .")
		return
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def countofDev(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		l = await m.reply("**• جاري حساب عدد اساسيين البوت- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		lens = len(open(f"maindevsVII{bot_id}.json","r").readlines())
		time.sleep(.5)
		if lens == 0:
			return await l.edit("**• لم تقم برفع اي مطورين اساسيين في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return await l.edit(f"**• تم رفع {lens} مطور اساسي في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
#ATARI - #RsExS
#----------------------SpecialUser-----------------------
#ATARI
...
async def __show_sudos(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		l = await m.reply("**• جاري عرض المطورين - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		x = 1
		text = "**Bot sudo Users **:\n\n"
		for su in file:
			text += f"{x} - {su}"
		...
		time.sleep(1)
		if lens == 0:
			return await l.edit("**• لم يتم رفع مطورين في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return await l.edit(text=text)
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def countofsudos(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		l = await m.reply("**• جاري حساب عدد مطورين البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		lens = len(open(f"sudo{bot_id}.json","r").readlines())
		time.sleep(.5)
		if lens == 0:
			return await l.edit("**• لم تقم برفع اي مطورين في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return await l.edit(f"**• تم رفع {lens} مطور في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def get_copy_Sudo(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		l = await m.reply("**• جاري جلب نسخه للمطورين- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(2)
		if lenb == 0:
			return await l.edit("**• لم تقم برفع اي مطور في البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		await l.delete()
		await m.reply_document(document=file,caption=f"**Sudo users {lenb} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .")
		return
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")	
...
async def show_users(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		for us in users:
			text += f"{x} - {us} \n"
			x+=1
		i = await m.reply("**• جارى عرض الاعضاء - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(.5)
		lenm = len(open(f"Users{bot_id}.json","r").readlines())
		if lenm == 0:
			return await i.edit("**• لم يقم اي عضو بالدخول للبوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return await i.edit(text=text)
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
async def __get_users_copy(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		l = await m.reply("**• جاري سحب نسخه للاعضاء - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		time.sleep(2)
		lenu = len(open(f"Users{bot_id}.json","r").readlines())
		users = open(f"Users{bot_id}.json","rb")
		if lenu == 0:
			return await l.edit("**• لم يقم اي عضو بالدخول الي البوت - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		await l.delete()
		await m.reply_document(document=users,caption=f"**Bot users {lenu} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
...
#--------------------Subscribe----------------------
#لاتصير فاشل وتخمط حقوق المطور اتاري 
...
async def AddKey(c:Client,m:Message):
	...
	if str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		await m.reply('**تم وضع {} قناة اشتراك - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**'.format(ask.text))
		return
...
async def AddChannel(c:Client,m:Message):
	...
	if str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		await m.reply('**تم وضع قناه المطور @{} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**'.format(ask.text))
		return
...
async def AddDevUser(c:Client,m:Message):
	...
	if str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		await m.reply('**تم وضع معرف المطور @{} - 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**'.format(ask.text))
		return
...
#ههههههههههههه فاشل كاعد تخمط مو
#-------------------------------------------------------------
#------------------------DelOwner-----------------------
...
async def ShowOwner(c:Client,m:Message):
	...
	if(user) in owner or int(user) == dev_owner:
		...
		time.sleep(1)
		if lens == 0:
			return await l.edit("**• لم يتم رفع مالكين في البوت- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		return await l.edit(text=text)
	return await m.reply("**• انت لست مطور في البوت \n- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")				        
...
async def ShowBan(c:Client,m:Message):
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		file = open(f"band{bot_id}.json","r")
		lens = len(open(f"band{bot_id}.json","r").readlines())
		l = await m.reply("**• جاري عرض المحظورين- 𝖱𝗌𝖤x𝖲 𝖳𝖾𝖠𝗆 .**")
		x = 1
		text = "**Bot Ban Users **:\n\n"
		for su in file:
			text += f"{x} - {su}"
