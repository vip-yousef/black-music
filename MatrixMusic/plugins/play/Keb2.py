...
@app.on_message(filters.reply & filters.command(["غنيلي","‹ غنيلي ›"]) & filters.private & filters.group)
...
@app.on_message(filters.reply & filters.command(["‹ صور ›","صور"]) & filters.group)
async def aTari(client: Client, message: Message):
